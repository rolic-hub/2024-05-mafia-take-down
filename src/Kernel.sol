...
abstract contract Module is KernelAdapter {
    ...
    modifier permissioned() {
        //q what is the output of msg.sig? The funtion selector
...
abstract contract Policy is KernelAdapter {
    ...
    //checks if the msg.sender has a particular role, and reverts if they dont.
    ...
    // Checks if a keycode is tied to a module and reverts if it isn't else returns the address of the module.
...
contract Kernel {
    ...
    mapping(Keycode => mapping(Policy => mapping(bytes4 => bool))) public modulePermissions; // for policy addr, check
        // if they have permission to call the function in the module
    ...
    //Only the admin(the wallet that deploys this contract ) can grant roles to addresses
